...
public class AutoInsertHandler implements InsertHandler<LookupElement> {

    private final String template;

    public AutoInsertHandler(String template) {
    ...
    public void handleInsert(@NotNull InsertionContext context, LookupElement item) {
        ...
        if (documentText.charAt(offset) != '{') {
            ...
            Template template = TemplateManager.getInstance(project).createTemplate("braces", "api", this.template);
